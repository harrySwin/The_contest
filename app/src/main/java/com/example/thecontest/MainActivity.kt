...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val homeDisplay = findViewById<TextView>(R.id.scoreHome)
        val awayDisplay = findViewById<TextView>(R.id.scoreAway)
        ...
        home_score.setOnClickListener {
            val homeScoreSound = MediaPlayer.create(this,R.raw.homescore)
        ...
        away_score.setOnClickListener {
            val awayScoreSound = MediaPlayer.create(this,R.raw.awayscore)
    ...
    fun checkWinner(homeScore: Int, awayScore: Int): Boolean {
        if (homeScore == 15) {
            val homeWinSound = MediaPlayer.create(this,R.raw.homewin)
            homeWinSound.start()
        ...
        if (awayScore == 15) {
            val awayWinSound = MediaPlayer.create(this,R.raw.awaywin)
            awayWinSound.start()
